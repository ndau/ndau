...
func TestRouting(t *testing.T) {
	...
	routes := []rt{
		...
		rt{"GET", "/account/history/123456", "/account/history/:accountid"},
		...
		rt{"GET", "/node/unconfirmed", "/node/unconfirmed"},
		...
		rt{"POST", "/tx/changevalidation", "/tx/changevalidation"},
		rt{"POST", "/tx/changesettlement", "/tx/changesettlement"},
		rt{"POST", "/tx/claimaccount", "/tx/claimaccount"},
		rt{"POST", "/tx/claimnoderewards", "/tx/claimnoderewards"},
		rt{"POST", "/tx/crediteai", "/tx/crediteai"},
		rt{"POST", "/tx/delegate", "/tx/delegate"},
		rt{"POST", "/tx/lock", "/tx/lock"},
		rt{"POST", "/tx/nominatenodereward", "/tx/nominatenodereward"},
		rt{"POST", "/tx/notify", "/tx/notify"},
		rt{"POST", "/tx/registernode", "/tx/registernode"},
		rt{"POST", "/tx/releasefromendowment", "/tx/releasefromendowment"},
		rt{"POST", "/tx/setrewardsdest", "/tx/setrewardsdest"},
		rt{"POST", "/tx/stake", "/tx/stake"},
		rt{"POST", "/tx/transfer", "/tx/transfer"},
		rt{"POST", "/tx/transferandlock", "/tx/transferandlock"},
