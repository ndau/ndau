...
// DecodeMsg implements msgp.Decodable
func (z *HistoricalValue) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z *HistoricalValue) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 2
	// write "Height"
...
// MarshalMsg implements msgp.Marshaler
func (z *HistoricalValue) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 2
	// string "Height"
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *HistoricalValue) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *HistoricalValue) Msgsize() (s int) {
	s = 1 + 7 + msgp.Uint64Size + 6 + msgp.BytesPrefixSize + len(z.Value)
	return
}

// DecodeMsg implements msgp.Decodable
func (z *KeyHistoryResponse) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
	...
	for zb0001 > 0 {
		...
		case "History":
			...
			if cap(z.History) >= int(zb0002) {
				...
				z.History = make([]HistoricalValue, zb0002)
			}
...
// EncodeMsg implements msgp.Encodable
func (z *KeyHistoryResponse) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "History"
...
// MarshalMsg implements msgp.Marshaler
func (z *KeyHistoryResponse) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 1
	// string "History"
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *KeyHistoryResponse) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *KeyHistoryResponse) Msgsize() (s int) {
