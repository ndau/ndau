...
func TestMarshalUnmarshalB64Data(t *testing.T) {
	v := B64Data{}
...
func BenchmarkMarshalMsgB64Data(b *testing.B) {
	v := B64Data{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgB64Data(b *testing.B) {
	v := B64Data{}
...
func BenchmarkUnmarshalB64Data(b *testing.B) {
	v := B64Data{}
...
func TestEncodeDecodeB64Data(t *testing.T) {
	v := B64Data{}
...
func BenchmarkEncodeB64Data(b *testing.B) {
	v := B64Data{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
...
func BenchmarkDecodeB64Data(b *testing.B) {
	v := B64Data{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func TestMarshalUnmarshalNamespacedKey(t *testing.T) {
	v := NamespacedKey{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgNamespacedKey(b *testing.B) {
	v := NamespacedKey{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgNamespacedKey(b *testing.B) {
	v := NamespacedKey{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalNamespacedKey(b *testing.B) {
	v := NamespacedKey{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeNamespacedKey(t *testing.T) {
	v := NamespacedKey{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
...
func BenchmarkEncodeNamespacedKey(b *testing.B) {
	v := NamespacedKey{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeNamespacedKey(b *testing.B) {
	v := NamespacedKey{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
